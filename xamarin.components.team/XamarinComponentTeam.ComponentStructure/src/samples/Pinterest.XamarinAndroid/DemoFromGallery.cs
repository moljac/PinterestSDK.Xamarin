...
namespace Pinterest.App.XamarinAndroid
{
	...
	public class DemoFromGallery : Activity
	{
		...
		private PinterestSDK.PinItButton mPinIt;
		...
		protected override void OnCreate(Bundle savedInstanceState) 
		{
			...
			mPinIt = FindViewById<PinterestSDK.PinItButton>(Resource.Id.pin_bt);
			mPinIt.Url = WEB_URL;
			mPinIt.Description = DEFAULT_DESCRIPTION;
			PinterestSDK.PinItButton.DebugMode = true;
			PinterestSDK.PinItButton.PartnerId = "myApp";
			PinterestSDK.PinItButton.PartnerId = DemoMainActivity.CLIENT_ID;
