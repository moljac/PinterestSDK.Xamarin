...
namespace Pinterest.App.XamarinAndroid
{
	...
	public class DemoFromGallery : Activity
	{
	    ...
	    private Com.Pinterest.Pinit.PinItButton mPinIt;
	    ...
	    protected override void OnCreate(Bundle savedInstanceState) 
		{
			...
			mPinIt = FindViewById<Com.Pinterest.Pinit.PinItButton>(Resource.Id.pin_bt);
	        mPinIt.Url = WEB_URL;
	        mPinIt.Description = DEFAULT_DESCRIPTION;
	        Com.Pinterest.Pinit.PinItButton.DebugMode = true;
	        Com.Pinterest.Pinit.PinItButton.PartnerId = "myApp";
	        Com.Pinterest.Pinit.PinItButton.PartnerId = DemoMainActivity.CLIENT_ID;
